    ...
    return (
      <div id="projects" className="page">
        ...
        <div>
          ...
          <div className='thumbnail-container'>
            <a href='https://codepen.io/viktharien/project/live/AYPaLO/' target='_blank'><img src='http://res.cloudinary.com/viktharien/image/upload/v1509718850/2_wzce9c.png'/></a>
          </div>
        </div>
